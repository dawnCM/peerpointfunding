...
class ApplicationController extends AppController {
	...
	public function beforeFilter() {
		...
		$this->Session->write('Application.Campaign_id', '5a0a8f2a6f85c');
		$this->Session->write('Application.Campaign_key', 'GTDBRHkCqjd9ryKb4nfw');
	...
	private function leadSubmit(){
		...
		//$url = "http://api.leadstudio.com/processCrmLeadInactive";
