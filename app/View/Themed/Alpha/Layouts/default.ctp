...
<html lang="en">
    <head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-71925930-12"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());

		  gtag('config', 'UA-71925930-12');
		</script>

        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
        <meta name="description" content="PeerPoint Funding, the cash you need now!  Approving you... not your credit score">
        <title>PeerPoint Funding - Get Your Share!  Online Approvals in Minutes!</title>
	...
	<div id="cm_pghd_wrap">
		<div class="container">
	    	<div class="row">
	        	<div class="col-sm-12">
	            	<div id="cm_logo">
	                <?php echo $this->Html->image('ppf_logo.png', array('alt'=>'PeerPointFunding', 'class'=>'img-responsive', 'width'=>'250', 'height'=>'70', 'url'=>'/')); ?> 
	                </div>
	                <div id="cm_nav">
	                    <nav class="navbar">
	                      <div class="container-fluid">
	                        ...
	                        <div class="collapse navbar-collapse" id="navbar_top">
	                          <ul class="nav navbar-nav navbar-right">
	                            <li><a href="https://global.leadstudio.com/works" data-title="How This Site Works" data-toggle="lightbox" data-gallery="remoteload"><i class="fa fa-cog"></i><br>How It Works</a></li>
	                            <li><a href="https://global.leadstudio.com/faq" data-title="FAQ's" data-toggle="lightbox" data-gallery="remoteload"><i class="fa fa-question"></i><br>FAQs</a></li>
	                            <li><a href="https://global.leadstudio.com/privacy?site=Site%20Name" data-title="Privacy Policy" data-toggle="lightbox" data-gallery="remoteload"><i class="fa fa-eye"></i><br>Privacy</a></li>
	                            <li><a href="https://global.leadstudio.com/about" data-title="About our Credit Providers" data-toggle="lightbox" data-gallery="remoteload"><i class="fa fa-info"></i><br>About</a></li>
	                            <li><a href="https://global.leadstudio.com/contact" data-title="Contact Us" data-toggle="lightbox" data-gallery="remoteload"><i class="fa fa-envelope-o"></i><br>Contact</a></li>
	                          </ul>
	                        </div><!-- /.navbar-collapse -->
	                      </div><!-- /.container-fluid -->
	                    </nav>
		...
		<div id="footer_wrap">
			<div class="container">
		    	<div class="row">
		        	<div class="col-sm-12">
		                <div class="panel-group" id="accordionft">
		                  <div class="panel panel-default">
		                    <div class="panel-heading">
		                      <h4 class="panel-title">
		                        <a data-toggle="collapse" data-parent="#accordionft" href="#collapseFour">
		...
		<strong>What this means for you:</strong> When you open an account, the lender will ask for your name, address, date of birth, and other information that will allow the lender to identify you. The lender may also ask to see your driver’s license or other identifying documents. 
		                  ...
		                  <div class="panel panel-default">
		                    <div class="panel-heading">
		                      <h4 class="panel-title">
		                        <a data-toggle="collapse" data-parent="#accordionft" href="#collapseOne">
...
When using our service to find a lender, the lender is required to provide you, the consumer, with all costs associated to be expressed as an annual percentage rate of interest (APR). This information will include the identity of the lender, the amount financed, the itemization of amount financed, the finance charge, the annual percentage rate, your payment schedule and your total number of payments. You will be able to review all this information BEFORE you obligate yourself to any loan. Your interest rate will vary depending upon which product you select from which lender. In addition, the Federal Equal Credit Opportunity Act prohibits lenders from discriminating against applicants on the basis of color, race, religion, sex, marital status and age.
		                  ...
		                  <div class="panel panel-default">
		                    <div class="panel-heading">
		                      <h4 class="panel-title">
		                        <a data-toggle="collapse" data-parent="#accordionft" href="#collapseTwo">
...
Because there are many lenders offering many different products we don’t know the exact APR that a lender may offer you.  But rest assured, your lender must disclose all this information to you before you obligate yourself to any loan.  The APR on a personal loan from our network of lenders can range from 5.99% to 35.99%, with loan durations between 90 days and 72 months. The actual loan rate depends on the loan amount and term requested, as well as your credit score, usage, and history. If you are offered a loan, you will have the opportunity to review the final offer made by the lender, and to accept the loan agreement made directly between you and the lender.				
		                  ...
		                  <div class="panel panel-default">
		                    <div class="panel-heading">
		                      <h4 class="panel-title">
		                        <a data-toggle="collapse" data-parent="#accordionft" href="#collapseThree">
		        ...
		        <div class="row">
					...
					<script src="https://stage.ola-memberseal.org/js/seal.js?seal=member&token=RVEY0jGRUS5nemainrIU&sealwidth=100&sealheight=100">
					</script>
					<!--Official OLA Member Seal-->
		        	<br>
		            Copyright &copy; <? echo date('Y')?> PeerPoint Funding<br />
		        <a href="https://global.leadstudio.com/terms" data-title="Terms and Conditions" data-toggle="lightbox" data-gallery="remoteload">Terms of Use</a> | <a href="https://global.leadstudio.com/privacy?site=AccessPoint%20Lending" data-title="Privacy Policy" data-toggle="lightbox" data-gallery="remoteload">Privacy Policy</a> | <a href="http://www.optout-wvcx.net/o-fhqt-s86-7d44b1ce4ff127eb8453f27dde274108&amp;cr=106" target="_blank">Unsubscribe</a> | <a href="http://cmportal.leadspedia.net/affiliate/signup/index.html" target="_blank">Become an Affiliate</a>
		            </div>
		        </div>
		    </div>
		</div>
